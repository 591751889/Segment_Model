...
class RDAUNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=1):
        ...
        self.dilated_conv1 = DilatedConvBlock(1024, 1024, dilation=1)
        self.dilated_conv2 = DilatedConvBlock(1024, 1024, dilation=2)
        self.dilated_conv3 = DilatedConvBlock(1024, 1024, dilation=4)
        self.dilated_conv4 = DilatedConvBlock(1024, 1024, dilation=8)
        self.dilated_conv5 = DilatedConvBlock(1024, 1024, dilation=16)
        self.dilated_conv6 = DilatedConvBlock(1024, 1024, dilation=32)
    ...
    def forward(self, x):
        ...
        p4 = self.pool4(c4)
        c5 = self.conv5(p4)
        c5 = self.dilated_conv1(c5)
        c5 = self.dilated_conv2(c5)
        c5 = self.dilated_conv3(c5)
        c5 = self.dilated_conv4(c5)
        c5 = self.dilated_conv5(c5)
        c5 = self.dilated_conv6(c5)
        up_6 = self.up6(c5)
...
if __name__ == "__main__":
    model = RDAUNet(in_channels=3, num_classes=2)
